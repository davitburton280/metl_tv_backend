...
router.post('/add', validatePlaylistDetails.rules, playlistController.add);
...
router.put('/update-playlist-info', validatePlaylistDetails.rules, playlistController.updatePlaylistInfo);
