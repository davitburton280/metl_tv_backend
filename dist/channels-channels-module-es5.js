...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["channels-channels-module"], {
  ...
  function srcAppChannelsShowChannelShowChannelComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _shared_components_stocks_lists_stocks_lists_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! @shared/components/stocks-lists/stocks-lists.component */
    "./src/app/shared/components/stocks-lists/stocks-lists.component.ts");
    /* harmony import */
    ...
    var ShowChannelComponent = /*#__PURE__*/function () {
      ...
      _createClass(ShowChannelComponent, [{
        ...
        value: function openModal() {
          this.dialog.open(_shared_components_stocks_lists_stocks_lists_component__WEBPACK_IMPORTED_MODULE_7__["StocksListsComponent"], {
            maxWidth: '100vw',
            maxHeight: '100vh',
            height: '100%',
            width: '100%'
  ...
  function srcAppChannelsShowChannelWatchlistTabWatchlistTabComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _core_services_stocks_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    ...
    function WatchlistTabComponent_ng_container_2_div_1_Template(rf, ctx) {
      if (rf & 1) {
        var _r4 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function WatchlistTabComponent_ng_container_2_div_1_Template_button_click_2_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r4);
          ...
          return ctx_r3.followStock(stock_r2);
        });
    ...
    function WatchlistTabComponent_ng_container_2_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
    ...
    var WatchlistTabComponent = /*#__PURE__*/function () {
      function WatchlistTabComponent(videoService, subjectService, router, getExactParams, stocksService, getAuthUser) {
      ...
      _createClass(WatchlistTabComponent, [{
        ...
        key: "getStocksByType",
        value: function getStocksByType(type) {
          var _this15 = this;

          this.stocksLoading = 'loading';
          this.stocksService.getStocksByType({
            type: type
          }).subscribe(function (dt) {
            _this15.stocks = dt;
            _this15.stocksLoading = 'finished';

            _this15.filterStocks();
          });
        } // Filters routes for floating panel

      }, {
        key: "filterStocks",
        value: function filterStocks() {
        ...
        key: "followStock",
        value: function followStock(stock) {
          var _this16 = this;

          var following = this.userStocks.find(function (f) {
            return f.name === stock.name;
          });
          ...
          if (!following) {
            ...
            this.userStocks = this.userStocks.filter(function (f) {
              return f.name !== stock.name;
            });
          }
          ...
          this.stocksService.updateFollowedStocks({
            ...
            _this16.userStocks = dt.user_stocks;
          });
        }
      }, {
        key: "isStockFollowed",
        value: function isStockFollowed(stock) {
          return !!this.userStocks.find(function (s) {
            return s.name === stock.name;
          });
        }
      }, {
        key: "compareWithMainStockList",
        value: function compareWithMainStockList(userStocks) {
          var _this17 = this;

          userStocks.map(function (st) {
            var found = _this17.stocks.find(function (fs) {
              return fs.name === st.name;
            });
        ...
        value: function getUserStocks() {
          ...
          this.stocksService.getUserStocks({
            ...
            _this18.userStocks = dt.user_stocks;
          });
        }
      }, {
        key: "ngOnDestroy",
    ...
    WatchlistTabComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 3,
      vars: 1,
      consts: [[1, "favorites"], [1, "crypto-content"], [4, "ngIf"], ["class", "crypto-item", 3, "crypto-item-green", 4, "ngFor", "ngForOf"], [1, "crypto-item"], [1, "stock-follow"], [3, "click"], [1, "crypto-text-1"], [1, "crypto-text-2"], [1, "crypto-text-abs"], [1, "crypto-block"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](WatchlistTabComponent, [{
        ...
        return [{
          ...
          type: _core_services_stocks_service__WEBPACK_IMPORTED_MODULE_6__["StocksService"]
        }, {
        ...
        value: function subscribeToChannel(channel) {
          ...
          this.channelsService.subscribeToChannel({
            ...
            _this20.channelsService.getUserChannelSubscriptions({
              ...
              _this20.getUserChannelSubscriptions();
            });
          });
        }
      }]);
