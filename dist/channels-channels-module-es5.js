...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["channels-channels-module"], {
  ...
  function srcAppChannelsShowChannelShowChannelComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    ShowChannelComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
      ...
      decls: 4,
      vars: 3,
      consts: [[1, "profile-list"], [3, "tagSelected", 4, "ngIf"], [4, "ngIf"], ["class", "channel-not-found", 4, "ngIf"], [3, "tagSelected"], [3, "channelUser", "authUser"], [1, "stocks-watchlist", "pWatchlist"], [1, "profile-list", "user-profile-block"], ["id", "channel-tabs-list", "role", "tablist", 1, "nav", "nav-tabs"], ["class", "nav-item", 4, "ngFor", "ngForOf"], ["id", "search-videos-form", 3, "formGroup"], [1, "toggle-filters-btn"], ["class", "filter-toggle-btn", "type", "button", 3, "filters-active", "click", 4, "ngIf"], ["class", "open-add-stock-modal", 3, "click", 4, "ngIf"], ["class", "watchlist-search", 4, "ngIf"], [3, "channelUser", 4, "ngIf"], [3, "channelUser", "authUser", 4, "ngIf"], [1, "nav-item"], ["data-toggle", "tab", "role", "tab", "aria-controls", "pWatch", "aria-selected", "true", 1, "nav-link", 3, "id", "href", "click"], ["type", "button", 1, "filter-toggle-btn", 3, "click"], [1, "open-add-stock-modal", 3, "click"], ["type", "button"], [1, "watchlist-search"], ["placeholder", "Search", "formControlName", "search", 1, "watchlist-input", 3, "keyup.enter"], [1, "fas", "fa-search"], [3, "channelUser"], [1, "channel-not-found"]],
  ...
  function srcAppChannelsShowChannelWatchlistTabWatchlistTabComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _core_helpers_update_stock_details__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! @core/helpers/update-stock-details */
    "./src/app/core/helpers/update-stock-details.ts");
    /* harmony import */
    ...
    var _shared_components_stocks_list_sample_stocks_list_sample_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    ...
    function WatchlistTabComponent_div_0_app_stocks_list_sample_2_Template(rf, ctx) {
      if (rf & 1) {
        var _r4 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "app-stocks-list-sample", 4);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("updatedStocksList", function WatchlistTabComponent_div_0_app_stocks_list_sample_2_Template_app_stocks_list_sample_updatedStocksList_0_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r4);

          var ctx_r3 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2);

          return ctx_r3.updateStocksList($event);
        });
    ...
    var WatchlistTabComponent = /*#__PURE__*/function () {
      function WatchlistTabComponent(videoService, subjectService, router, getExactParams, stocksService, getAuthUser, subject, cdr, loader) {
      ...
      _createClass(WatchlistTabComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.subject.currentUserStocks.subscribe(function (dt) {
            _this15.userStocks = dt;

            if (dt.length > 0) {
              _this15.getBatchStocksList();
            }
          });
        }
      }, {
        key: "getBatchStocksList",
        value: function getBatchStocksList() {
          var _this16 = this;

          var stocks = '';
          this.userStocks.map(function (us, index) {
            stocks += us.symbol + (index === _this16.userStocks.length - 1 ? '' : ',');
          });
          this.stocksLoading = 'loading';
          this.subscriptions.push(this.stocksService.getBatchStocksList({
            stocks: stocks
          }).subscribe(function (dt) {
            _this16.stocks = dt;
        ...
        key: "updateStocksList",
        value: function updateStocksList(stocks) {
          var _this17 = this;
          ...
          this.subscriptions.push(this.stocksService.updateFollowedStocks(Object.assign({
            ...
            _this17.subject.changeUserStocks(_this17.userStocks);
        ...
        key: "updateStockDetails",
        value: function updateStockDetails(userStocks) {
    ...
    WatchlistTabComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 1,
      vars: 1,
      consts: [[4, "ngIf"], [3, "diameter", 4, "ngIf"], [3, "stocks", "userStocks", "updatedStocksList", 4, "ngIf"], [3, "diameter"], [3, "stocks", "userStocks", "updatedStocksList"]],
      ...
      directives: [_angular_common__WEBPACK_IMPORTED_MODULE_10__["NgIf"], _angular_material_progress_spinner__WEBPACK_IMPORTED_MODULE_11__["MatSpinner"], _shared_components_stocks_list_sample_stocks_list_sample_component__WEBPACK_IMPORTED_MODULE_12__["StocksListSampleComponent"]],
