...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["stocks-stocks-module"], {
  ...
  function srcAppStocksStockProfileStockProfileComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _shared_components_stocks_tiles_stock_tiles_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    ...
    function StockProfileComponent_app_stock_tiles_7_Template(rf, ctx) {
      if (rf & 1) {
    ...
    StockProfileComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
      ...
      decls: 10,
      vars: 4,
      consts: [[1, "stock-content"], [1, "major-indexes"], [1, "stocks-list-container"], [1, "spinner-container"], [3, "diameter", 4, "ngIf"], [3, "stocks", "dragDropDisabled", "followingAllowed", "stockProfileAllowed", 4, "ngIf"], ["class", "stock-tabs", 4, "ngIf"], [4, "ngIf"], [3, "diameter"], [3, "stocks", "dragDropDisabled", "followingAllowed", "stockProfileAllowed"], [1, "stock-tabs"], [1, "nav", "nav-tabs"], ["data-toggle", "tab", 3, "click"], [1, "tab-content"], ["id", "summary"], [3, "selectedStock", "hidden"], ["id", "historical"]],
    ...
    var SummaryTabComponent = /*#__PURE__*/function () {
      ...
      _createClass(SummaryTabComponent, [{
        ...
        value: function updateUserStocks(stock) {
          ...
          var removal = this.isStockFollowed(stock);
          var result = this.updateStocks.transform(this.userStocks, stock, removal);
