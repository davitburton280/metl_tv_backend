...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["stocks-stocks-module"], {
  ...
  function srcAppStocksStockProfileStockProfileComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _app_stocks_stock_profile_summary_tab_summary_tab_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    ...
    var _app_stocks_stock_profile_historical_tab_historical_tab_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    ...
    function StockProfileComponent_div_6_Template(rf, ctx) {
      if (rf & 1) {
        var _r5 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div", 7);

        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function StockProfileComponent_div_6_Template_div_click_0_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r5);

          var stock_r3 = ctx.$implicit;

          var ctx_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]();

          return ctx_r4.openStockProfile(stock_r3.symbol);
        });
    ...
    function StockProfileComponent_div_7_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function StockProfileComponent_div_7_Template_a_click_3_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r7);

          var ctx_r6 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]();

          return ctx_r6.changeTab("summary");
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function StockProfileComponent_div_7_Template_a_click_6_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r7);

          var ctx_r8 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]();

          return ctx_r8.changeTab("historical");
        });
    ...
    function StockProfileComponent_mat_error_8_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var StockProfileComponent = /*#__PURE__*/function () {
      function StockProfileComponent(stocksService, router, route) {
      ...
      _createClass(StockProfileComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.stocksService.getIndices({}).subscribe(function (dt) {
            _this2.indices = dt;
          });
    ...
    StockProfileComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
      ...
      decls: 9,
      vars: 3,
      consts: [[1, "stock-content"], [1, "major-indexes"], [1, "favorites"], [1, "crypto-content"], ["class", "crypto-item", 3, "crypto-item-green", "click", 4, "ngFor", "ngForOf"], ["class", "stock-tabs", 4, "ngIf"], [4, "ngIf"], [1, "crypto-item", 3, "click"], [1, "crypto-text-1"], [1, "crypto-text-2"], [1, "crypto-text-abs"], [1, "crypto-block"], [1, "stock-tabs"], [1, "nav", "nav-tabs"], ["data-toggle", "tab", 3, "click"], [1, "tab-content"], ["id", "summary"], [3, "selectedStock", "hidden"], ["id", "historical"]],
      ...
      directives: [_angular_common__WEBPACK_IMPORTED_MODULE_4__["NgForOf"], _angular_common__WEBPACK_IMPORTED_MODULE_4__["NgIf"], _app_stocks_stock_profile_summary_tab_summary_tab_component__WEBPACK_IMPORTED_MODULE_5__["SummaryTabComponent"], _app_stocks_stock_profile_historical_tab_historical_tab_component__WEBPACK_IMPORTED_MODULE_6__["HistoricalTabComponent"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_7__["MatError"]],
      styles: [".crypto-section[_ngcontent-%COMP%] {\n  background: #0E1D43 0 0 no-repeat padding-box;\n  width: 100%;\n  padding: 60px 200px;\n  margin: -1.75rem auto;\n  min-height: calc(100vh - 2px);\n}\n.crypto-section[_ngcontent-%COMP%]   .top-wrap[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  color: #FFFFFF;\n  font-size: 24px;\n  font-weight: bold;\n  flex-wrap: wrap;\n}\n.crypto-section[_ngcontent-%COMP%]   .top-wrap[_ngcontent-%COMP%]   h2[_ngcontent-%COMP%] {\n  margin: 0;\n}\n.crypto-section[_ngcontent-%COMP%]   .top-wrap[_ngcontent-%COMP%]   i[_ngcontent-%COMP%] {\n  font-size: 20px;\n  cursor: pointer;\n  transition: 0.2s;\n}\n.crypto-section[_ngcontent-%COMP%]   .top-wrap[_ngcontent-%COMP%]   i[_ngcontent-%COMP%]:hover {\n  color: #F53C6F;\n}\n.crypto-content[_ngcontent-%COMP%] {\n  padding: 32px 0 0;\n  display: flex;\n  flex-wrap: wrap;\n}\n.crypto-item[_ngcontent-%COMP%] {\n  position: relative;\n  width: 200px;\n  height: 179px;\n  margin-bottom: 32px;\n  background: #F53C6F 0 0 no-repeat padding-box;\n  padding: 24px 8px;\n  border: 1px dashed transparent;\n  transition: 0.2s;\n  margin-right: 13px;\n  cursor: pointer;\n}\n.crypto-item[_ngcontent-%COMP%]:hover {\n  border: 1px dashed #FFFFFF;\n}\n.crypto-item[_ngcontent-%COMP%]   .cryptoRemove[_ngcontent-%COMP%], .crypto-item[_ngcontent-%COMP%]   .stock-follow[_ngcontent-%COMP%] {\n  position: absolute;\n  top: 0;\n  right: 5px;\n  cursor: pointer;\n}\n.crypto-item[_ngcontent-%COMP%]   .cryptoRemove[_ngcontent-%COMP%]:hover   span[_ngcontent-%COMP%], .crypto-item[_ngcontent-%COMP%]   .stock-follow[_ngcontent-%COMP%]:hover   span[_ngcontent-%COMP%] {\n  font-size: 20px;\n}\n.crypto-item[_ngcontent-%COMP%]   .cryptoRemove[_ngcontent-%COMP%]   span[_ngcontent-%COMP%], .crypto-item[_ngcontent-%COMP%]   .stock-follow[_ngcontent-%COMP%]   span[_ngcontent-%COMP%] {\n  color: #FFFFFF;\n  font-size: 16px;\n  transition: 0.1s;\n}\n.crypto-item[_ngcontent-%COMP%]   .stock-follow[_ngcontent-%COMP%]   button[_ngcontent-%COMP%] {\n  background: none;\n  color: white;\n  text-transform: uppercase;\n  padding: 3px;\n  font-size: 9px;\n  border: 1px solid white;\n  font-weight: bold;\n  border-radius: 0px;\n}\n.addStockWrap[_ngcontent-%COMP%]   .crypto-item[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  background: #0D1B3E;\n  color: #FFFFFF;\n  border: 1px dashed #FFFFFF;\n  transition: 0.2s;\n  cursor: pointer;\n}\n.addStockWrap[_ngcontent-%COMP%]   .crypto-item[_ngcontent-%COMP%]:hover {\n  background: #2b4380;\n}\n.crypto-item-red[_ngcontent-%COMP%] {\n  background: #F53C6F;\n}\n.crypto-item-green[_ngcontent-%COMP%] {\n  background: #18B587;\n}\n.crypto-text-1[_ngcontent-%COMP%] {\n  color: #FFFFFF;\n  font-size: 14px;\n  font-family: \"Muli-Light\";\n  margin-bottom: 4px;\n  overflow: hidden;\n  display: -webkit-box;\n  -webkit-line-clamp: 2;\n  -webkit-box-orient: vertical;\n}\n.crypto-text-2[_ngcontent-%COMP%] {\n  color: #FFFFFF;\n  font-size: 26px;\n  line-height: 26px;\n  font-family: \"Muli-Bold\";\n  margin-bottom: 4px;\n  position: relative;\n  margin-left: 6px;\n}\n.crypto-text-abs[_ngcontent-%COMP%] {\n  position: absolute;\n  left: -5px;\n  top: -6px;\n  font-size: 16px;\n  font-family: \"Muli-Bold\";\n}\n.crypto-block[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  width: 130px;\n}\n.crypto-map[_ngcontent-%COMP%] {\n  width: 100%;\n}\n.modal-dialog[_ngcontent-%COMP%] {\n  margin: 0 !important;\n}\n.all-stocks[_ngcontent-%COMP%]   .mat-paginator[_ngcontent-%COMP%] {\n  background: transparent;\n  color: white;\n  font-family: \"Muli-Regular\";\n  font-size: 12px;\n}\napp-search-stocks-form[_ngcontent-%COMP%] {\n  padding-top: 10px !important;\n}\nselect[_ngcontent-%COMP%] {\n  background: transparent;\n  border-bottom: 1px solid #ffffff !important;\n  border-left: none;\n  border-right: none;\n  border-top: none;\n  font-family: \"Muli-Light\";\n  font-size: 18px;\n  color: #ffffff !important;\n}\nselect[_ngcontent-%COMP%]:focus {\n  outline: none;\n}\nselect[_ngcontent-%COMP%]   option[_ngcontent-%COMP%] {\n  color: #000000 !important;\n}\n.center-group[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n.stock-type-selector[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  max-width: 200px;\n  width: 100%;\n}\n@media (max-width: 1400px) {\n  .crypto-section[_ngcontent-%COMP%] {\n    padding: 60px 150px;\n  }\n}\n@media (max-width: 991px) {\n  .crypto-section[_ngcontent-%COMP%] {\n    padding: 60px 50px;\n    justify-content: space-around;\n  }\n\n  .crypto-content[_ngcontent-%COMP%] {\n    justify-content: space-around;\n  }\n}\n.stock-select[_ngcontent-%COMP%] {\n  width: 316px;\n  height: 51px;\n  background: #EEEEEE 0 0 no-repeat padding-box;\n  box-shadow: 0 0 6px #9A9A9A24;\n  color: #545454;\n  font-size: 16px;\n  padding: 16px;\n  font-family: \"Muli-Regular\";\n  outline: 0;\n  border: 0;\n  margin-right: 32px;\n}\n.my-stocks[_ngcontent-%COMP%] {\n  width: 200px;\n  height: 51px;\n  box-shadow: 0 0 6px #9A9A9A24;\n  background: #F53C6F;\n  font-size: 16px;\n  font-family: \"Muli-Regular\";\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  color: white !important;\n}\n.prospective-stocks[_ngcontent-%COMP%] {\n  width: 200px;\n  height: 51px;\n  background: #F53C6F 0 0 no-repeat padding-box;\n  box-shadow: 0 0 6px #9A9A9A24;\n  background: #EEEEEE;\n  font-size: 16px;\n  font-family: \"Muli-Regular\";\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  color: #545454 !important;\n}\n.stock-block[_ngcontent-%COMP%] {\n  display: flex;\n  margin-bottom: 32px;\n}\n.stock-content-img[_ngcontent-%COMP%] {\n  width: 100%;\n}\n.stock-btns[_ngcontent-%COMP%] {\n  display: flex;\n}\n.stock-tabs[_ngcontent-%COMP%]   li[_ngcontent-%COMP%] {\n  height: 35px;\n  padding: 5px;\n}\n.stock-tabs[_ngcontent-%COMP%]   a[_ngcontent-%COMP%] {\n  color: #000000;\n  text-decoration: none;\n}\n.stock-tabs[_ngcontent-%COMP%]   .active[_ngcontent-%COMP%] {\n  background: #F53C6F;\n}\n.stock-tabs[_ngcontent-%COMP%]   .active[_ngcontent-%COMP%]   a[_ngcontent-%COMP%] {\n  color: white;\n}\n.small-chart-container[_ngcontent-%COMP%] {\n  width: 100%;\n  height: 150px;\n}\n@media (max-width: 991px) {\n  .stock-block[_ngcontent-%COMP%] {\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n  }\n\n  .stock-select[_ngcontent-%COMP%] {\n    margin-right: 0;\n    margin-bottom: 20px;\n  }\n}\n@media (max-width: 480px) {\n  .stock-select[_ngcontent-%COMP%] {\n    width: 80%;\n  }\n\n  .stock-btns[_ngcontent-%COMP%] {\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n  }\n\n  .prospective-stocks[_ngcontent-%COMP%] {\n    margin-top: 20px;\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */"]
    });
    /*@__PURE__*/
  ...
  function srcAppStocksStockProfileSummaryTabSummaryTabComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _core_services_stocks_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! @core/services/stocks.service */
    "./src/app/core/services/stocks.service.ts");
    /* harmony import */


    var _core_services_loader_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    ...
    function SummaryTabComponent_mat_spinner_2_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var SummaryTabComponent = /*#__PURE__*/function () {
      function SummaryTabComponent(stocksService, loader) {
      ...
      _createClass(SummaryTabComponent, [{
        ...
        value: function getStockInfo() {
          ...
          this.stocksService.getStockChartData({
            ...
            _this4.chartData = dt.chart;
            _this4.tableData = new _angular_material_table__WEBPACK_IMPORTED_MODULE_1__["MatTableDataSource"](dt.table);
            _this4.loader.dataLoading = false;
          });
        }
      }]);
    ...
    SummaryTabComponent.ɵfac = function SummaryTabComponent_Factory(t) {
      return new (t || SummaryTabComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_core_services_stocks_service__WEBPACK_IMPORTED_MODULE_3__["StocksService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_core_services_loader_service__WEBPACK_IMPORTED_MODULE_4__["LoaderService"]));
    };
    ...
    SummaryTabComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 5,
      vars: 3,
      consts: [[1, "table-chart-container"], [1, "loader"], [3, "diameter", 4, "ngIf"], [4, "ngIf"], [3, "diameter"], [1, "chart-container"], [3, "scheme", "legend", "showXAxisLabel", "showYAxisLabel", "autoScale", "xAxis", "yAxis", "results"], [1, "table-container"], [1, "selected-stock"], ["mat-table", "", 1, "mat-elevation-z8", 3, "dataSource"], [4, "ngFor", "ngForOf"], ["mat-header-row", "", 4, "matHeaderRowDef"], ["mat-row", "", 4, "matRowDef", "matRowDefColumns"], [3, "matColumnDef"], ["mat-header-cell", "", 4, "matHeaderCellDef"], ["mat-cell", "", 4, "matCellDef"], ["mat-header-cell", ""], ["mat-cell", ""], ["mat-header-row", ""], ["mat-row", ""]],
      ...
      directives: [_angular_common__WEBPACK_IMPORTED_MODULE_5__["NgIf"], _angular_material_progress_spinner__WEBPACK_IMPORTED_MODULE_6__["MatSpinner"], _swimlane_ngx_charts__WEBPACK_IMPORTED_MODULE_7__["AreaChartComponent"], _angular_material_table__WEBPACK_IMPORTED_MODULE_1__["MatTable"], _angular_common__WEBPACK_IMPORTED_MODULE_5__["NgForOf"], _angular_material_table__WEBPACK_IMPORTED_MODULE_1__["MatHeaderRowDef"], _angular_material_table__WEBPACK_IMPORTED_MODULE_1__["MatRowDef"], _angular_material_table__WEBPACK_IMPORTED_MODULE_1__["MatColumnDef"], _angular_material_table__WEBPACK_IMPORTED_MODULE_1__["MatHeaderCellDef"], _angular_material_table__WEBPACK_IMPORTED_MODULE_1__["MatCellDef"], _angular_material_table__WEBPACK_IMPORTED_MODULE_1__["MatHeaderCell"], _angular_material_table__WEBPACK_IMPORTED_MODULE_1__["MatCell"], _angular_material_table__WEBPACK_IMPORTED_MODULE_1__["MatHeaderRow"], _angular_material_table__WEBPACK_IMPORTED_MODULE_1__["MatRow"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_8__["MatError"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SummaryTabComponent, [{
        ...
        return [{
          type: _core_services_stocks_service__WEBPACK_IMPORTED_MODULE_3__["StocksService"]
        }, {
          type: _core_services_loader_service__WEBPACK_IMPORTED_MODULE_4__["LoaderService"]
        }];
      }, {
        selectedStock: [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"],
